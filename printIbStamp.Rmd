---
#title: "Registre TimbreDu Timbre Fédéral de négociation"
...
timbre <- timbre[TradeDate > as.Date("2017-10-01") & 
...
colnames(timbre) <- c("OrderTime", "AssetClass", 
                      "Nom", "Isin",
                      "Date.Op", "Dev", 
                      "Type", "Nominal",   
                      "Prix",  "Proceed",
                      "Client",  "Cours" , 
                      "Soumis CH", "Soumis ETR", 
                      "Non Soumis", "cliNbr")

setorder(timbre, OrderTime, Nom, -Client)

# add Client Domicile
timbre[, Dom:= ifelse(grepl("Interactive", Client), "ETR", "CH")]
...
# remove some columns
timbre$OrderTime <- timbre$cliNbr <- timbre$Proceed <- NULL
